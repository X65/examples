...
;   Modified for X65 microcomputer by smokku.
;
;	.SID start:
;
...
.segment "INFO"
    .byte "Hubbard_Rob_Monty_on_the_Run.sid"
...
; NormalLuser Edited this to work with VASM and RetroAssembler.
...
SID_V2_FreqL    = SID_Base + $7
SID_V2_FreqH    = SID_Base + $8
SID_V2_PulseL   = SID_Base + $9
SID_V2_PulseH   = SID_Base + $A
SID_V2_Ctrl     = SID_Base + $B
SID_V2_AttDecay = SID_Base + $C
SID_V2_SusRel   = SID_Base + $D

SID_V3_FreqL    = SID_Base + $E
SID_V3_FreqH    = SID_Base + $F
SID_V3_PulseL   = SID_Base + $10
SID_V3_PulseH   = SID_Base + $11
SID_V3_Ctrl     = SID_Base + $12
SID_V3_AttDecay = SID_Base + $13
SID_V3_SusRel   = SID_Base + $14
